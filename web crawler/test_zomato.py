...
class Zomato:
    ...
    def restaurant_search(self, query="", latitude="", longitude="", cuisines="", limit=20,start=0):
        """
...
for val in range(0, 101, 20):
			results=zomato.restaurant_search("","40.732013" , "-73.996155", "italian",start=val)
			
			d = json.loads(results)
			
			for restaurant in d.items():
				print(restaurant[1])
				print("---------------------------")
